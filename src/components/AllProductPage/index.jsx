  ...
  return (
    <Layout childrenClasses="pt-0 pb-0">
      <div className="products-page-wrapper w-full bg-white pt-[60px] pb-[114px]">
        <div className="container-x mx-auto">
          {/* Breadcrumb */}
          <div className="py-6 flex justify-center items-center relative mb-20 bg-cover bg-center rounded-3xl overflow-hidden min-h-[150px]" style={{ backgroundImage: "url('/images/banner.jpg')" }}>
